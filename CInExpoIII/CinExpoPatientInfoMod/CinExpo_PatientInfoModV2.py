...
class PatientInfoScreen(StackLayout):
                ...
                def __init__(self, **kwargs):
                    ...
                    Temp = Button( text='Temp:', background_normal= u'Buttons/bluBtn.jpg', font_size=36, size_hint= [.15, .2])
                    self.add_widget(Temp)
                    
                    ECG = Button( text='ECG:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .2])
                    self.add_widget(ECG)                  
                    
                    Ox = Button( text='Spo2:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .2])
                    self.add_widget(Ox)

                    BPM = Button( text='BPM:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .2])
                    self.add_widget(BPM)
                    
                    Air = Button( text='Breathing \nRate:', background_normal= u'Buttons/bluBtn.jpg', font_size=36, size_hint= [.15, .2])
                    self.add_widget(Air)
                    
                    Press = Button( text='Blood\nPressure:' , background_normal= u'Buttons/bluBtn.jpg',   font_size=36,size_hint= [.15, .2])
                    self.add_widget(Press)                               
                    
                    RTSBox = Button( text='RTS:', font_size=48, background_normal= u'Buttons/greBtn.jpg', size_hint= [.15, .2])
                    self.add_widget(RTSBox)

                    Alert = Button( text='Alert:' , background_normal= u'Buttons/greBtn.jpg', font_size=36, size_hint= [.5, .1])
                    self.add_widget(Alert)
                    
                    Logo=  Button( background_normal= u'Logo.png', background_down = u'Logo.png',size_hint= [.3, .3])
                    self.add_widget(Logo)
                    
                    GCSbox = TextInput( hint_text = GCSmsg, font_size = 36, multiline=False, size_hint= [.3, .1])
