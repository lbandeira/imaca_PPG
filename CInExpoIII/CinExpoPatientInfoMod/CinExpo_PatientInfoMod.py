...
class PatientInfoScreen(FloatLayout):
                ...
                def __init__(self, **kwargs):
                    ...
                    Temp = Button( pos = [10, 960], text='Temp:', background_normal= u'Buttons/bluBtn.jpg', font_size=36, size_hint= [.15, .1])
                    self.add_widget(Temp)
                    
                    ECG = Button( pos = [10, 780], text='ECG:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .1])
                    self.add_widget(ECG)                  
                    
                    Ox = Button( pos = [10, 600], text='Spo2:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .1])
                    self.add_widget(Ox)

                    BPM = Button( pos = [10, 420], text='BPM:', font_size=36, background_normal= u'Buttons/bluBtn.jpg', size_hint= [.15, .1])
                    self.add_widget(BPM)
                    
                    Air = Button( pos = [10, 240], text='Breathing \nRate:', background_normal= u'Buttons/bluBtn.jpg', font_size=36, size_hint= [.15, .1])
                    self.add_widget(Air)
                    
                    Press = Button( pos = [10, 60], text='Blood\nPressure:' , background_normal= u'Buttons/bluBtn.jpg',   font_size=36,size_hint= [.15, .1])
                    self.add_widget(Press)                               
                    
                    GCSbox = TextInput( pos = [680, 600], hint_text = GCSmsg, font_size = 36, multiline=False, size_hint= [.3, .1])
                    self.add_widget(GCSbox)

                    RTSBox = Button( pos = [800, 852], text='RTS:', font_size=48, background_normal= u'Buttons/greBtn.jpg', size_hint= [.15, .2])
                    self.add_widget(RTSBox)

                    Logo=  Button( pos = [680, 0], background_normal= u'Logo.png', background_down = u'Logo.png',size_hint= [.3, .3])
                    self.add_widget(Logo)
 
                    Alert = Button( pos = [540, 400], text='Alert:' , background_normal= u'Buttons/greBtn.jpg', font_size=36, size_hint= [.5, .1])
...
##                        ox   = ser.readline().strip()
                    ...
                    db.child(iMacaDB).update({"RTS": format(rts, '.2f')})
